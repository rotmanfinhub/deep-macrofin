...
from deep_macrofin import ActivationType, Comparator, OptimizerType, set_seeds, LayerType
```

2. Define problem.  
Here, we use the default training configuration, and setup differently for learnable endogenous variable. 
```py
